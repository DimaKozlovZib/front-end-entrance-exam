...
Я выполнил все основные и дополнительные требования проекта.

https://dimakozlovzib.github.io/front-end-entrance-exam-page/

### Ключевые особенности:
- Реализована смена фотографии и иконок (tools)
- Для запуска достаточно открыть `index.html` через Live Server или любой другой локальный сервер
- Добавлены уведомления

### Генерация PDF:
- Использованы библиотеки **jsPDF** и **html2canvas**, что предусмотрено тз
- Для обеспечения фиксированной ширины PDF независимо от экрана пользователя:
  1. Создается скрытая копия резюме
  2. Копия масштабируется под заданные размеры
  3. Происходит генерация PDF

### Работа с данными:
- Данные сохраняются при событии `blur` (снятие фокуса с поля)
- Визуальная обратная связь:
  - Появляется уведомление в правом верхнем углу
  - Активируется анимация Material Wave при получении фокуса (`click` событие)
